...
const SignUp = () => {
  ...
  const onFailure = (errors: unknown) => {
    console.log(errors);
  };
      ...
      <div className="card-body rounded-0 text-left">
        ...
        <Form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <Form.Group as={Col} md="12" className="mb-3">
            ...
            />
            <Form.Control.Feedback type={errors.nombre ? "invalid" : "valid"}>
          ...
          <Form.Group as={Col} md="12" className="mb-3">
            ...
            <Form.Control.Feedback type={errors.contrasena ? "invalid" : "valid"}>
          ...
          <Form.Group as={Col} md="12" className="mb-3">
            ...
            <Form.Control.Feedback type={errors.contrasena2 ? "invalid" : "valid"}>
